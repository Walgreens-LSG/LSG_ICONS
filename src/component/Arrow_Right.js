...
import {ReactComponent as Icon} from "../stories/assets/individual/icon__arrow-right.svg";


//Storybook Constants
export const WagIconArrowRight= ({
    ...
    const WagIconArrowRight = styled(Icon)`
...
WagIconArrowRight.defaultProps = {
    size:"default",
    alt: "Arrow right",
    fill:"#284b9b"
};