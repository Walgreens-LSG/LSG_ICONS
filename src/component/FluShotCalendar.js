...
import {ReactComponent as Icon} from "../stories/assets/individual/flu-shot-cal.svg";


//Storybook Constants
export const WagIconFluShotCalendar = ({
    ...
    const WagIconFluShotCalendar= styled(Icon)`
...
WagIconFluShotCalendar.propTypes = {
/**
...
WagIconFluShotCalendar.defaultProps = {
    size:"default",
    alt: "Flu shot calendar",
    fill:"#284b9b"
};