...
import {ReactComponent as Icon} from "../stories/assets/individual/icon__arrow-left-up.svg";


//Storybook Constants
export const WagIconArrowLeftUp= ({
    ...
    const WagIconArrowLeftUp = styled(Icon)`
...
WagIconArrowLeftUp.defaultProps = {
    size:"default",
    alt: "Arrow left up",
    fill:"#284b9b"
};