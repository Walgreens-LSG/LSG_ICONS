...
import {ReactComponent as Icon} from "../stories/assets/individual/express-rx.svg";


//Storybook Constants
export const WagIconPillBottleExpress = ({
    ...
    const WagIconPillBottleExpress= styled(Icon)`
...
WagIconPillBottleExpress.propTypes = {
/**
...
WagIconPillBottleExpress.defaultProps = {
    size:"default",
    alt: "Pill bottle express rx",
    fill:"#284b9b"
};