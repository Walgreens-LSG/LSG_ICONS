...
import {ReactComponent as Icon} from "../stories/assets/individual/insurance-card.svg";


//Storybook Constants
export const WagIconInsuranceCard = ({
    ...
    const WagIconInsuranceCard= styled(Icon)`
...
WagIconInsuranceCard.propTypes = {
/**
...
WagIconInsuranceCard.defaultProps = {
    size:"default",
    alt: "Insurance Card",
    fill:"#284b9b"
};