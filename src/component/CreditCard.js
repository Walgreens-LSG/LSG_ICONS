...
import {ReactComponent as Icon} from "../stories/assets/individual/credit-card.svg";


//Storybook Constants
export const WagIconCreditCard = ({
    ...
    const WagIconCreditCard= styled(Icon)`
...
WagIconCreditCard.defaultProps = {
    size:"default",
    alt: "Credit Card",
    fill:"#284b9b"
};