...
import {ReactComponent as Clock} from "../stories/assets/individual/same-day-pickup.svg";


//Storybook Constants
export const WagIconClockSameDayPickup = ({
    ...
    const WagIconClockSameDayPickup = styled(Clock)`
...
WagIconClockSameDayPickup.propTypes = {
/**
...
WagIconClockSameDayPickup.defaultProps = {
    size:"default",
    alt: "Clock - Same day pickup",
    fill: "#284b9b"
};