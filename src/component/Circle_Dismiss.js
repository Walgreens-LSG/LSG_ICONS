...
import {ReactComponent as Icon} from "../stories/assets/individual/dismiss.svg";


//Storybook Constants
export const WagIconCircleDismiss= ({
    ...
    const WagIconCircleDismiss= styled(Icon)`
...
WagIconCircleDismiss.propTypes = {
/**
...
WagIconCircleDismiss.defaultProps = {
    size:"default",
    alt: "Dismiss",
    fill:"#284b9b"
};