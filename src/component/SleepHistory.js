...
import {ReactComponent as Icon} from "../stories/assets/individual/sleep-history.svg";


//Storybook Constants
export const WagIconSleepHistory = ({
    ...
    const WagIconSleepHistory= styled(Icon)`
...
WagIconSleepHistory.defaultProps = {
    size:"default",
    alt: "Sleep History",
    fill:"#284b9b"
};