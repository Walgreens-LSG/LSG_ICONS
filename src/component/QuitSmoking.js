...
import {ReactComponent as Icon} from "../stories/assets/individual/quit-smoking.svg";


//Storybook Constants
export const WagIconQuitSmoking = ({
    ...
    const WagIconQuitSmoking= styled(Icon)`
...
WagIconQuitSmoking.defaultProps = {
    size:"default",
    alt: "Quit Smoking",
    fill:"#284b9b"
};