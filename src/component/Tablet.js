...
import {ReactComponent as Tablet} from "../stories/assets/individual/tablet.svg";


//Storybook Constants
export const WagIconTablet = ({
    ...
    const WagIconTablet = styled(Tablet)`
