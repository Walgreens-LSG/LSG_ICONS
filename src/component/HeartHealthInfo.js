...
import {ReactComponent as Icon} from "../stories/assets/individual/health-info.svg";


//Storybook Constants
export const WagIconHeartHealthInfo = ({
    ...
    const WagIconHeartHealthInfo= styled(Icon)`
...
WagIconHeartHealthInfo.propTypes = {
/**
...
WagIconHeartHealthInfo.defaultProps = {
    size:"default",
    alt: "Heart health info",
    fill:"#284b9b"
};