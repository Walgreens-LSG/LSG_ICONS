...
import {ReactComponent as Content} from "../stories/assets/individual/content.svg";


//Storybook Constants
export const WagIconContent = ({
    ...
    const WagIconContent= styled(Content)`
