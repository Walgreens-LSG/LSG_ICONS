...
import {ReactComponent as Record_Add} from "../stories/assets/individual/add-to-record.svg";


//Storybook Constants
export const WagIconRecordAdd = ({
    ...
    const WagIconRecordAdd= styled(Record_Add)`
