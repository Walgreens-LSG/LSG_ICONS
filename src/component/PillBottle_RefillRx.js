...
import {ReactComponent as Icon} from "../stories/assets/individual/rx-refill.svg";


//Storybook Constants
export const WagIconPillBottleRefillRx = ({
    ...
    const WagIconPillBottleRefillRx= styled(Icon)`
...
WagIconPillBottleRefillRx.propTypes = {
/**
...
WagIconPillBottleRefillRx.defaultProps = {
    size:"default",
    alt: "Pill bottle refill rx",
    fill:"#284b9b"
};