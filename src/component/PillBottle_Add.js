...
import {ReactComponent as Icon} from "../stories/assets/individual/pill-bottle-alt.svg";


//Storybook Constants
export const WagIconPillBottleAdd = ({
    ...
    const WagIconPillBottleAdd= styled(Icon)`
...
WagIconPillBottleAdd.propTypes = {
/**
...
WagIconPillBottleAdd.defaultProps = {
    size:"default",
    alt: "Pill bottle",
    fill:"#284b9b"
};