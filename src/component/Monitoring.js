...
import {ReactComponent as Icon} from "../stories/assets/individual/monitoring.svg";


//Storybook Constants
export const WagIconMonitoring = ({
    ...
    const WagIconMonitoring= styled(Icon)`
...
WagIconMonitoring.defaultProps = {
    size:"default",
    alt: "Monitoring",
    fill:"#284b9b"
};