...
import {ReactComponent as Icon} from "../stories/assets/individual/settings.svg";


//Storybook Constants
export const WagIconSettings= ({
    ...
    const WagIconSettings= styled(Icon)`
