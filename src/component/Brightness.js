...
import {ReactComponent as Icon} from "../stories/assets/individual/brightness.svg";


//Storybook Constants
export const WagIconBrightness = ({
    ...
    const WagIconBrightness = styled(Icon)`
...
WagIconBrightness.defaultProps = {
    size:"default",
    alt: "Brightness",
    fill:"#284b9b"
};