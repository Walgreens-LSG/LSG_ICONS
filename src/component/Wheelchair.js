...
import {ReactComponent as Icon} from "../stories/assets/individual/wheel-chair.svg";


//Storybook Constants
export const WagIconWheelchair = ({
    ...
    const WagIconWheelchair= styled(Icon)`
...
WagIconWheelchair.defaultProps = {
    size:"default",
    alt: "Wheelchair",
    fill:"#284b9b"
};