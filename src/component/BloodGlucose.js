...
import {ReactComponent as Icon} from "../stories/assets/individual/blood-glucose.svg";


//Storybook Constants
export const WagIconBloodGlucose = ({
    ...
    const WagIconBloodGlucose= styled(Icon)`
...
WagIconBloodGlucose.defaultProps = {
    size:"default",
    alt: "Blood glucose",
    fill:"#284b9b"
};