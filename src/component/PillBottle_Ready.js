...
import {ReactComponent as Icon} from "../stories/assets/individual/pill-bottle-ready.svg";


//Storybook Constants
export const WagIconPillBottleReady = ({
    ...
    const WagIconPillBottleReady= styled(Icon)`
...
WagIconPillBottleReady.propTypes = {
/**
...
WagIconPillBottleReady.defaultProps = {
    size:"default",
    alt: "Pill bottle ready",
    fill:"#284b9b"
};